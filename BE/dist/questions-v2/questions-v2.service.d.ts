...
export declare class QuestionsService {
    ...
    private mapAiImprovementStatus;
    private normalizeAiImprovementRecord;
    private validateAiImprovementFinal;
    private findActiveAiImprovement;
    createQuestionAiImprovement(dto: CreateQuestionAiImprovementDto, user: AuthUser): Promise<{
        id: any;
        jobId: any;
        status: string;
        rawStatus: any;
    ...
    getQuestionAiImprovement(id: string, user: AuthUser): Promise<{
        id: any;
        jobId: any;
        status: string;
        rawStatus: any;
    ...
    updateQuestionAiImprovementDraft(id: string, dto: UpdateQuestionAiImprovementDraftDto, user: AuthUser): Promise<{
        id: any;
        jobId: any;
        status: string;
        rawStatus: any;
    ...
    approveQuestionAiImprovement(id: string, dto: ApproveQuestionAiImprovementDto, user: AuthUser): Promise<{
    ...
    rejectQuestionAiImprovement(id: string, dto: RejectQuestionAiImprovementDto, user: AuthUser): Promise<{
        id: any;
        jobId: any;
        status: string;
        rawStatus: any;
