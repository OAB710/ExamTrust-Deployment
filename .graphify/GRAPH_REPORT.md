...
## Corpus Check
- Large corpus: 520 files · ~417,225 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 2535 nodes · 6377 edges · 151 communities detected
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output
- Edge kinds: imports: 1509 · contains: 1365 · MODIFIES: 1031 · imports_from: 939 · method: 625 · calls: 551 · ON_BRANCH: 157 · PARENT_OF: 98 · references: 79 · inherits: 11 · implements: 10 · rationale_for: 2


## Input Scope
- Requested: auto
- Resolved: committed (source: default-auto)
- Included files: 520 · Candidates: 559
- Excluded: 322 untracked · 99243 ignored · 1 sensitive · 0 missing committed
- Recommendation: Use --scope all or graphify.yaml inputs.corpus for a knowledge-base folder.

## Graph Freshness
- Built from Git commit: `f2db362`
...
- `093b6ef Merge pull request #6 from OAB710/main` --ON_BRANCH--> `duc`  [EXTRACTED]
  git → git  _Bridges community 18 → community 5_
- `0aae96f add` --ON_BRANCH--> `duc`  [EXTRACTED]
  git → git  _Bridges community 10 → community 5_
- `0aae96f add` --PARENT_OF--> `0e4348a add`  [EXTRACTED]
  git → git  _Bridges community 10 → community 38_
...
Cohesion: 0.05
Nodes (65): BackendRole, BackendStatus, EMPTY_CREATE_FORM, EMPTY_EDIT_FORM, EMPTY_FILTERS, USER_FILTERS, UserForm, UserRow (+57 more)

### Community 2 - "Community 2"
Cohesion: 0.06
Nodes (57): iso(), rangeFor(), Exam, Submission, User, AdminStatCard(), AdminStatCardProps, PRIORITY_STYLES (+49 more)
...
Cohesion: 0.08
Nodes (51): AiModule, duc, main, 007a277 Update ZaloBotFeature, 06d86ad Apply gitignore and remove generated files from tracking, 0716f8a Zalo Web Hook, 0c12096 Update page.tsx, 14c973c Add Cloudflare Workers deployment config for FE via OpenNext (+43 more)
...
Cohesion: 0.07
Nodes (32): AdminPageShell(), AdminPageShellProps, EMPTY_FILTERS, Exam, REVIEW_COPY, SEVERITY_COPY, Suggestion, ExamItem (+24 more)
...
Cohesion: 0.06
Nodes (35): IntegrityCaseDetail(), IntegrityCaseDetailProps, IntegrityTimelineEvent, EMPTY_FILTERS, EMPTY_PATTERNS, EMPTY_STATS, FlaggedSubmission, IntegrityCasesResponse (+27 more)

### Community 11 - "Community 11"
Cohesion: 0.08
Nodes (33): ExamSecurityModal(), ExamSecurityModalProps, violationLabels, emptyCounts, useExamSecurity(), UseExamSecurityOptions, UseExamSecurityResult, ViolationLog (+25 more)

### Community 12 - "Community 12"
Cohesion: 0.06
Nodes (21): 13dcbd7 add, 222b35a add, 24e5343 add, b27133b add, b9a4c06 add, AuthUser, AiSuggestion, DraftGrade (+13 more)

### Community 13 - "Community 13"
Cohesion: 0.07
Nodes (35): { academicYear: defaultAcademicYear, term: defaultTerm }, academicYearOptions, buildToken(), CourseForm, CourseItem, defaultForm, EMPTY_FILTERS, EnrollResult (+27 more)

### Community 14 - "Community 14"
Cohesion: 0.07
Nodes (24): ContextHelp(), ContextHelpProps, HelpBody(), HelpButton, HelpContent, isHelpContent(), useTouchHelpMode(), MetricCardProps (+16 more)

### Community 15 - "Community 15"
Cohesion: 0.07
Nodes (28): buildContextLines(), buildExamTrustPromptHeader(), ExamTrustAiAnalyticsSummary, ExamTrustAiContext, ExamTrustAiPromptParams, ExamTrustAiUseCase, formatNumber(), getOllamaGenerationOptions() (+20 more)
...
Cohesion: 0.08
Nodes (23): question_bank_preferences, users, 093b6ef Merge pull request #6 from OAB710/main, 1afe093 add, 28c06f5 Merge pull request #1 from trungducnguyen4/main, 36549ac AI GEN QUES, 9d34aad Merge branch 'main' into duc, f5fcba9 Merge pull request #5 from OAB710/main (+15 more)
...
Cohesion: 0.09
Nodes (22): AttentionItemData, AttentionPriority, LecturerAttentionResponse, LecturerAttentionSummary, LECTURER_ATTENTION_QUERY_KEY, PRIORITY_ORDER, useAttentionItems(), AuthContext (+14 more)
...
Cohesion: 0.15
Nodes (13): QuestionTopicDialog(), EditorQuestionType, useQuestionAnswerState(), useQuestionPersistence(), Params, TopicSuggestion, useQuestionTopics(), CorrectAnswerPayload (+5 more)
...
Cohesion: 0.15
Nodes (13): 72d5704 add, 7b4322c add, f604860 add, bootstrap(), parseCsvList(), CalendarView, ExamDetailsDialog(), FlexibleExamCard() (+5 more)
...
Cohesion: 0.12
Nodes (17): 3221af2 Merge pull request #2 from OAB710/main, 563dc34 Merge pull request #3 from trungducnguyen4/duc, f4c84b8 add, AddLogsDto, AutosaveAnswerDto, AutosaveExamDto, CreateScoreAdjustmentDto, FinalizeEvidenceCaptureDto (+9 more)

### Community 37 - "Community 37"
Cohesion: 0.15
Nodes (4): DEFAULT_POLICY, OnModuleInit, ProctoringEvidenceService, WebcamEvidencePolicy

### Community 38 - "Community 38"
Cohesion: 0.13
Nodes (8): AI_SECTIONS, AiJobsService, AISectionValue, AiTaskType, CreateAiJobParams, 0e4348a add, 1ea6b35 add, AuthUser
...
Cohesion: 0.24
Nodes (13): formatAttemptLimitVi(), formatDateTimeVi(), formatDateVi(), formatNumberVi(), formatPercentVi(), formatScoreVi(), getAttemptStatusLabel(), getExamStatusLabel() (+5 more)
...
Cohesion: 0.26
Nodes (10): themes, ThemeToggle(), DropdownMenuCheckboxItem, DropdownMenuContent, DropdownMenuItem, DropdownMenuLabel, DropdownMenuRadioItem, DropdownMenuSeparator (+2 more)
...
Cohesion: 0.20
Nodes (6): answerTitles, FillBlankGuide(), OptionRowProps, Props, QuestionAnswerEditor(), Switch
...
Cohesion: 0.25
Nodes (8): backendTypeByEditorType, BuildPayloadParams, buildQuestionPayload(), editorTypeByBackendType, shuffle(), toEditorDifficulty(), toEditorQuestionType(), QuestionOption
...
## Knowledge Gaps
- **575 isolated node(s):** `local_ai_server.py — Minimal local model server for ExamTrust AI feature Uses l`, `Try to pull the first valid JSON object out of model output.`, `prisma`, `prisma`, `prisma` (+570 more)
...
- **Thin community `Community 20`** (1 nodes): `SubmissionsController`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 23`** (1 nodes): `ExamsService`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 26`** (2 nodes): `AiService`, `OnModuleInit`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 27`** (1 nodes): `QuestionDraftsController`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 31`** (1 nodes): `ExamsController`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 33`** (1 nodes): `AuthService`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 35`** (1 nodes): `AuthController`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 39`** (1 nodes): `CoursesService`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 43`** (1 nodes): `ExamLinksService`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 47`** (1 nodes): `EnrollmentsController`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 48`** (1 nodes): `EnrollmentsService`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 56`** (1 nodes): `CoursesController`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 60`** (1 nodes): `CacheService`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 65`** (1 nodes): `UsersService`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 70`** (1 nodes): `QueueService`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 72`** (1 nodes): `UsersController`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 74`** (1 nodes): `ExamLinksController`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 80`** (2 nodes): `ExamQualityReviewService`, `RequestUser`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 89`** (1 nodes): `AiController`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 93`** (1 nodes): `AIGenerationProcessor`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 94`** (1 nodes): `AccessPolicyService`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 103`** (1 nodes): `QuestionMetadataController`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 110`** (1 nodes): `AdminDashboardService`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 111`** (1 nodes): `AuditService`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 112`** (1 nodes): `RateLimiterService`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 113`** (2 nodes): `CanActivate`, `RolesGuard`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 115`** (1 nodes): `ApiRequestError`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 123`** (1 nodes): `AiStatusController`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 124`** (1 nodes): `AuditController`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 126`** (2 nodes): `PaginatedResult`, `PaginationDto`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 129`** (1 nodes): `LecturerDashboardController`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 130`** (1 nodes): `LecturerDashboardService`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 133`** (1 nodes): `MailerService`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 140`** (1 nodes): `SubmissionsEventsService`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 142`** (2 nodes): `notifications`, `users`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 143`** (2 nodes): `courses`, `topics`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 144`** (2 nodes): `courses`, `exam_snapshots`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 146`** (2 nodes): `ai_generation_records`, `anomaly_flags`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 147`** (2 nodes): `QualityReviewDecision`, `ReviewQualitySuggestionDto`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 148`** (2 nodes): `LecturerAttentionItemDto`, `LecturerAttentionResponseDto`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 159`** (1 nodes): `prisma`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 160`** (1 nodes): `mocks`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `ApiClient` connect `Community 0` to `Community 22`, `Community 114`, `Community 101`, `Community 131`, `Community 132`, `Community 161`, `Community 115`?**
  _High betweenness centrality (0.105) - this node is a cross-community bridge._
- **Why does `SubmissionsService` connect `Community 24` to `Community 12`, `Community 95`, `Community 96`, `Community 84`, `Community 97`, `Community 141`, `Community 118`?**
  _High betweenness centrality (0.051) - this node is a cross-community bridge._
- **Why does `QuestionsService` connect `Community 9` to `Community 18`?**
...
- **Should `Community 1` be split into smaller, more focused modules?**
  _Cohesion score 0.04954128440366973 - nodes in this community are weakly interconnected._
