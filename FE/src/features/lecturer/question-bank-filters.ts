...
export const EMPTY_QUESTION_FILTERS: FilterValues = { type: "all", difficulty: "all", points: { min: undefined, max: undefined } };
...
export function filterAndSortQuestions(params: {
  ...
  return params.questions.filter((question) => {
    ...
    return matchesSearch && matchesCourse && matchesType && matchesDifficulty && matchesPoints;
  }).sort((a, b) => {
