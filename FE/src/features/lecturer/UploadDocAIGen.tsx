          ...
          <Card>
            <CardHeader>
              <CardTitle className="flex items-center gap-2">
                ...
                <HelpedTitle help={{
                  description: "Configure how AI generates questions from the uploaded document.",
                  usedBy: "Lecturers select the course, topic, difficulty, and question type before generating drafts.",
                  note: "AI output is saved to the bank only after lecturer review and approval.",
                }}>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  <div className="inline-flex items-center gap-1.5">
                    <Label>Topic</Label>
                    <ContextHelp content={{
                      description: "The topic assigned to questions generated by AI.",
                      usedBy: "Used to organize the question bank and analyze results by knowledge area.",
                      note: "Create or select a topic before approving questions to avoid unlabeled questions.",
                    }} />
                  </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="space-y-2">
                  <div className="inline-flex items-center gap-1.5">
                    ...
                    <ContextHelp content={{
                      description: "The target difficulty for questions generated by AI.",
                      usedBy: "Used when AI should generate easy, medium, hard, or mixed questions.",
                      note: "Lecturers should still review them because AI may estimate difficulty inaccurately.",
                    }} />
                  </div>
                ...
                <div className="space-y-2">
                  <div className="inline-flex items-center gap-1.5">
                    ...
                    <ContextHelp content={{
                      description: "The question type AI prioritizes when generating from the document.",
                      usedBy: "Used when questions must follow a desired exam structure.",
                      note: "If you select Mixed, review each question to ensure answers and rubrics are valid.",
                    }} />
                  </div>
