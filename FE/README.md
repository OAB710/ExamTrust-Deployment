...
- `D:\KLTN1\BE\academic-trust-suite-backend`: NestJS + Prisma backend API
- `D:\KLTN1\BE\academic-trust-suite-backend\prisma`: database schema, seed data, and migration files
...
Backend lives outside this frontend project:

```text
D:\KLTN1\BE\academic-trust-suite-backend
|-- src/                  # NestJS source
...
```bash
cd D:\KLTN1\BE\academic-trust-suite-backend
npm install
```
...
The Prisma schema, migrations, and seed scripts live in `D:\KLTN1\BE\academic-trust-suite-backend\prisma`.
...
- `D:\KLTN1\BE\academic-trust-suite-backend\API_DOCUMENTATION.md`
- `D:\KLTN1\BE\academic-trust-suite-backend\docs\question-v2-implementation-assets.md`
