...
## Corrective post-refactor audit

Completed a corrective audit after runtime inspection found untranslated text on the Lecturer Analytics route (`/lecturer/analytics`). The source was a combination of unaccented Vietnamese literals, HTML-entity-encoded JSX, corrupted-encoding fallbacks, shared faculty fallbacks, and analytics payload text generated by the backend.
...
- `FE/src/features/lecturer/CourseManagement.tsx`
- `FE/src/features/lecturer/LecturerDashboard.tsx`
- `BE/src/submissions/submissions.service.ts`

`BE/prisma/**`, seed data, fixtures, and database content were not changed as part of this corrective audit. The only remaining Vietnamese source strings are intentional spreadsheet import-header aliases in `BulkStudentImport.tsx`; **Bélády** is a proper name in a sample question.
